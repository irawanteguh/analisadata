...
$("#btndownloaddatatindakanrj_table").on("click", function () {

    exportToExcel(
        globaldatatindakanrj,
        "Tindakan Rawat Jalan",
        "Tindakan_Rawat_Jalan.xlsx",
        {
...
function datatindakanrj(){
    const selectperiode = $("select[name='selectperiode']").val();
    $.ajax({
        url       : url +"index.php/outpatient/tindakanrj/datatindakanrj",
        ...
        success:function(response){
            ...
            $("#resultdatatindakanrj").html(tableresult);
            const table = initDataTable("#datatindakanrj_table","#searchtable",50);
        },
        complete: function () {
            Swal.close();
        },
