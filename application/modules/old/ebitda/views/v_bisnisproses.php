		...
		<div class="card card-flush">
			<div class="card-header pt-5" id="">
				<h3 class="card-title align-items-start flex-column">
					<span class="card-label fw-bolder fs-3 mb-1">Bussiness Process</span>
				</h3>
				<div class="card-toolbar m-0">
					...
					<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
						...
						<div class="menu-item px-3">
							<a href="#" class="menu-link px-3">Add Bussiness Process</a>
						</div>
					</div>
				</div>
			</div>
			<div class="card-body py-3">
				<div class="table-responsive mh-610px" style="overflow-x:auto; white-space:nowrap;">
					<table class="table align-middle table-row-dashed fs-8 gy-2">
						...
						<tbody class="text-gray-600 fw-bold" id="resultdatabisnisproses"></tbody>
					</table>
				</div>
			</div>
		</div>
