		...
		<div class="card card-flush">
			<div class="card-header pt-5" id="">
				<h3 class="card-title align-items-start flex-column">
					<span class="card-label fw-bolder fs-3 mb-1">Rencana Pendapatan</span>
				</h3>
			...
			<div class="card-body py-3">
				<div class="table-responsive mh-610px" style="overflow-x:auto; white-space:nowrap;">
					<table class="table align-middle table-row-dashed fs-8 gy-2">
						...
						<tbody class="text-gray-600 fw-bold" id="resultdatarencanapendapatan"></tbody>
                        <tfoot class="align-middle">
                            <tr class="fw-bolder text-muted bg-light">
                                <th class="ps-4 rounded-start" colspan="5">Total Rencana Pendapatan</th>
                                <th class="text-end totalrencanapendapatan">0</th>
                                <th></th>
