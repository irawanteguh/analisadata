    ...
    <div class="card card-flush">
        ...
        <div class="card-body py-3">
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed gy-2 fs-8" id="datatindakanri_table">
                    ...
                    <tbody class="fw-bold text-gray-600" id="resultdatatindakanri"></tbody>
                </table>
            </div>
        </div>
    </div>
