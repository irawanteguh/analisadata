...
<div class="row">
        ...
        <div class="card card-flush">
            <div class="card-header pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Monitoring Penyelesaian Resume Medis Rawat Inap</span>
                    <span class="text-muted mt-1 fw-bold fs-7">Monitoring ketepatan waktu penyelesaian resume medis rawat inap ≤ 48 jam, > 48 jam, dan belum dibuat.</span>
                </h3>
    ...
    <div class="col-xl-3 mb-5">
        <div class="card card-flush">
            <div class="card-header pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Penyelesaian Resume Medis Rawat Inap</span>
                    <span class="text-muted mt-1 fw-bold fs-7">Ketepatan Waktu Resume Medis Rawat Inap</span>
                </h3>
                <div class="card-toolbar m-0">
                    <button type="button" class="btn btn-clean btn-sm btn-icon btn-icon-primary btn-active-light-primary me-n3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                        <span class="svg-icon svg-icon-3 svg-icon-primary">
