    ...
    <div class="card card-flush">
        <div class="card-header pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">Monitoring Penyelesaian Resume Medis</span>
                <span class="text-muted mt-1 fw-bold fs-7"> Daftar detail pasien rawat inap dengan status penyelesaian resume medis.</span>
            </h3>
            <div class="card-toolbar m-0">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <a href="#" class="menu-link px-3" id="btndownloaddatapendingresume_table">Download Excel</a>
                    </div>
                </div>
            </div>
        </div>
