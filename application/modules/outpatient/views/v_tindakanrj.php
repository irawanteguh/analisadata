    ...
    <div class="card card-flush">
        <div class="card-header pt-5">
            ...
            <div class="card-toolbar m-0">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <a href="#" class="menu-link px-3" id="btndownloaddatatindakanrj_table">Download Excel</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="card-body py-3">
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed gy-2 fs-8" id="datatindakanrj_table">
                    ...
                    <tbody class="fw-bold text-gray-600" id="resultdatatindakanrj"></tbody>
                </table>
            </div>
        </div>
    </div>
