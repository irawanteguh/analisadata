            ...
            <div class="card border border-primary bg-light-primary shadow-sm h-100">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <div>
                            <div class="fw-bold fs-6 text-primary">Jumlah Pasien</div>
                            <div class="text-muted" style="font-size:11px">
                                Pasien yang telah keluar dari rumah sakit pada periode yang dipilih
                            </div>
                        </div>
                    </div>
                    <div class="fw-bolder fs-4 text-primary">
                        <span id="jmlpasien">0</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border border-danger bg-light-danger shadow-sm h-100">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <div>
                            <div class="fw-bold fs-6 text-danger">Berkas Tidak Tepat Waktu</div>
                            <div class="text-muted" style="font-size:11px">
                                Berkasnya dikembalikan tidak tepat waktu
                            </div>
                        </div>
                    </div>
                    <div class="fw-bolder fs-4 text-danger">
                        <span id="jmltidaktepatwaktu">0</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border border-success bg-light-success shadow-sm h-100">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <div>
                            <div class="fw-bold fs-6 text-success">Berkas Tepat Waktu</div>
                            <div class="text-muted" style="font-size:11px">
                                Total Berkas yang dikembalikan tepat waktu
                            </div>
                        </div>
                    </div>
                    <div class="fw-bolder fs-4 text-success">
                        <span id="jmltepatwaktu">0</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card card-flush">
        <div class="card-header pt-5">
            ...
            <div class="card-toolbar m-0">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <a href="#" class="menu-link px-3" id="btndownloaddataberkas_table">Download Excel</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="card-body py-3">
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed gy-2 fs-8" id="databerkas_table">
                    <thead class="align-middle">
                        <tr class="fw-bolder text-muted bg-light">
                            ...
                            <th class="pe-4 rounded-end text-end">STATUS</th>
                        </tr>
                    </thead>
                    <tbody class="fw-bold text-gray-600" id="resultdataberkas"></tbody>
                </table>
            </div>
        </div>
    </div>
